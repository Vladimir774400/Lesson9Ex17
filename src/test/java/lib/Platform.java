...
public class Platform {
    ...
    public RemoteWebDriver getDriver() throws Exception
    {
        ...
        {
            throw new Exception("Cannot detect platform driver. Platform value is "+this.getPlatformVar());
        }
    }
    ...
    private DesiredCapabilities getIosDesiredCapabilities()
    {
        ...
        capabilities.setCapability("app", "C:/Users/vnartov/Desktop/JavaAppiumAutomatization/apks/Wikipedia.app");
        return capabilities;
    }
